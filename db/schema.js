...
export const playerCharacterInventory = pgTable(
...
export const magicItem = pgTable(
  "MagicItem",
  {
    id: uuid().primaryKey().notNull(),
    itemType: varchar("item_type"),
...
export const classFeature = pgTable(
  "ClassFeature",
  {
    id: uuid().primaryKey().notNull(),
    name: varchar(),
...
export const baseClass = pgTable(
  "BaseClass",
  {
    id: uuid().primaryKey().notNull(),
    name: varchar(),
...
export const armor = pgTable(
  ...
  (table) => [unique("Armor_magic_item_id_key").on(table.magicItemId)]
);

export const armorProperty = pgTable(
  "ArmorProperty",
  {
    id: uuid().primaryKey().notNull(),
...
export const raceFeature = pgTable(
  "RaceFeature",
  {
    id: uuid().primaryKey().notNull(),
    name: varchar(),
...
export const weaponDamage = pgTable(
  "WeaponDamage",
  {
    id: uuid().primaryKey().notNull(),
...
export const weaponProperty = pgTable(
  "WeaponProperty",
  {
    id: uuid().primaryKey().notNull(),
    weaponId: uuid("weapon_id"),
...
export const playerCharacterBackground = pgTable(
...
export const playerCharacterFeature = pgTable(
...
export const playerCharacterCondition = pgTable(
  "PlayerCharacterCondition",
  {
    id: uuid().primaryKey().notNull(),
    playerCharacterId: uuid("player_character_id"),
...
export const playerCharacterSkill = pgTable(
...
export const playerCharacterProficiency = pgTable(
...
export const playerCharacterCurrency = pgTable(
  "PlayerCharacterCurrency",
  {
    id: uuid().primaryKey().notNull(),
    playerCharacterId: uuid("player_character_id"),
...
export const playerCharacterClass = pgTable(
...
export const playerCharacterSpellcaster = pgTable(
  "PlayerCharacterSpellcaster",
  {
    id: uuid().primaryKey().notNull(),
    playerCharacterId: uuid("player_character_id"),
...
export const backgroundFeature = pgTable(
  "BackgroundFeature",
  {
    id: uuid().primaryKey().notNull(),
    name: varchar(),
...
export const attunedItems = pgTable(
  "AttunedItems",
  {
    id: uuid().primaryKey().notNull(),
    playerCharacterId: uuid("player_character_id"),
...
export const playerCharacterAbilityScore = pgTable(
  "PlayerCharacterAbilityScore",
  {
    id: uuid().primaryKey().notNull(),
    playerCharacterId: uuid("player_character_id"),
    abilityId: uuid("ability_id"),
