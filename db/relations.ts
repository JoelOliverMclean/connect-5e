...
export const playerCharacterInventoryRelations = relations(
  playerCharacterInventory,
  ({ one }) => ({
...
export const playerCharacterRelations = relations(
  playerCharacter,
  ({ one, many }) => ({
...
export const exhaustionLevelRelations = relations(
  exhaustionLevel,
  ({ many }) => ({
    playerCharacters: many(playerCharacter),
  })
...
export const playerCharacterBackgroundRelations = relations(
  playerCharacterBackground,
  ({ one }) => ({
    playerCharacter: one(playerCharacter, {
...
export const playerCharacterFeatureRelations = relations(
  playerCharacterFeature,
  ({ one }) => ({
    playerCharacter: one(playerCharacter, {
...
export const playerCharacterConditionRelations = relations(
  playerCharacterCondition,
  ({ one }) => ({
    playerCharacter: one(playerCharacter, {
...
export const playerCharacterSkillRelations = relations(
  playerCharacterSkill,
  ({ one }) => ({
    playerCharacter: one(playerCharacter, {
...
export const playerCharacterCurrencyRelations = relations(
  playerCharacterCurrency,
  ({ one }) => ({
    playerCharacter: one(playerCharacter, {
...
export const playerCharacterClassRelations = relations(
  playerCharacterClass,
  ({ one }) => ({
    playerCharacter: one(playerCharacter, {
...
export const backgroundFeatureRelations = relations(
  backgroundFeature,
  ({ one }) => ({
    background: one(background, {
...
export const playerCharacterAbilityScoreRelations = relations(
  playerCharacterAbilityScore,
  ({ one }) => ({
    ability: one(ability, {
